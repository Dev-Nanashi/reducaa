/* @ts-self-types="./reducaa_wasm.d.ts" */
...
export function compress(data, options) {
    ...
    const ret = wasm.compress(ptr0, len0, options);
    if (ret[2]) {
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('reducaa_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
